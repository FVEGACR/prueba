...
#import "ImageQualityFilter.h"
#import "LivenessDetectionPrecision.h"
#import "PatternQualityFilter.h"
...
*/
-(void) setMinimumDistanceBetweenEyesAllowed:(int) value :(NSError **)outError;
...
/**
	...
	@param outError Error.
*/
-(void) setMaximumDistanceBetweenEyesAllowed:(int) value :(NSError **)outError;
...
/**
	...
	@param outError Error.
*/
-(void) setMultiface:(bool) value :(NSError **)outError;
...
/**
	...
	@param outError Error.
*/
-(void) setMaxThreads:(int) value :(NSError **)outError;
...
/**
	...
	@param outError Error.
*/
-(void) setImageQualityFilter:(FPBImageQualityFilter) value :(NSError **)outError;
...
/**
	...
	@param outError Error.
*/
-(void) setLivenessDetectionPrecision:(FPBLivenessDetectionPrecision) value :(NSError **)outError;
...
/**
	...
	@param outError Error.
 */
-(void) setPatternQualityFilter:(FPBPatternQualityFilter) value :(NSError **)outError;
...
*/
+(FPBExtractorConfigurationManager *) GetSuggestedExtractorConfigurationManager:(int) widthImage :(int) heightImage;
 ...
 */
+(CGSize) GetBestResolution:(NSArray*) resolutionListAvailable :(CGSize) resolutionFrame :(CGSize)resolutionDesired :(float)aspectRatioTolerance :(int)minWidth :(int) maxWidth;
